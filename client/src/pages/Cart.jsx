          ...
          <section className="lg:col-span-7">
            <ul className="divide-y divide-gray-200 border-t border-b border-gray-200">
              {cartItems.map((product, idx) => (
                <li key={`${product._id}-${product.selectedSize}`} className="flex py-6 sm:py-10">
                  <img
                  ...
                  <div className="ml-4 flex-1 flex flex-col justify-between sm:ml-6">
                    <div className="sm:flex sm:justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-700 mt-1">
                          <span className="font-semibold">Size:</span> {product.selectedSize}
                        </p>
                        <p className="text-sm text-gray-700">
                          <span className="font-semibold">Unit Price:</span> ${product.price.toFixed(2)}
                        </p>
                      </div>
                    ...
                    <div className="mt-4 flex items-center justify-between sm:mt-0">
                      <div className="flex items-center space-x-2">
                        <button
                          onClick={() =>
                            handleQuantityChange(product._id, product.selectedSize, product.quantity - 1)
                          }
                      ...
                      <button
                        ...
                        onClick={() =>
                          dispatch({
                            type: 'REMOVE_ITEM',
                            payload: { id: product._id, selectedSize: product.selectedSize },
                          })
                        }
